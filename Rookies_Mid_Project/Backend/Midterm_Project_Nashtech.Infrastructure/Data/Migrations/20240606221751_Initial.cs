    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BorrowingRequest", x => x.RequestId);
                    table.ForeignKey(
                        name: "FK_BorrowingRequest_User_RequestorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequestsDetails", x => x.RequestDetailId);
                    table.ForeignKey(
                        name: "FK_RequestsDetails_Book_BookId",
                        column: x => x.BookId,
                        principalTable: "Book",
                        principalColumn: "BookId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RequestsDetails_BorrowingRequest_RequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BorrowingRequest_RequestorId",
                table: "BorrowingRequest",
                column: "RequestorId");

            migrationBuilder.CreateIndex(
                name: "IX_RequestsDetails_BookId",
                table: "RequestsDetails",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_RequestsDetails_RequestId",
                table: "RequestsDetails",
                column: "RequestId");
        }
